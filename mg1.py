def mg1_calculator():
    ...
    sigma = float(input(f"Ingrese el valor de la desviación estándar (σ) en los tiempos de servicio en {unidad_tiempo}: "))
    ...
    print(f"Promedio de tener cero clientes en el sistema: {pc}%")
